...
//import evt.{EventLikeSerializer, Targets, Pull, Observer}
//
///**
// * IDs:
...
// * 8 = String
// */
//trait TypeOld[ S <: evt.Sys[ S ], A ] extends Extensions[ S, A ] with TupleReader[ S, A ] {
//   tpe =>
//
//   type Ex     = Expr[ S, A ]
//   type ExN    = Expr[ S, A ] with event.Node[ S ]
