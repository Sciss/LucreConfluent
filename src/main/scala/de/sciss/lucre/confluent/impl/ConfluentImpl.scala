...
import concurrent.stm.{InTxn, Txn, TxnExecutor, TxnLocal}
...
//         val accTree    = acc.tree
    ...
    * of the tree.
    */
   private[confluent] final class Path[ S <: Sys[ S ]]( protected val tree: FingerTree[ (Int, Long), Long ])
